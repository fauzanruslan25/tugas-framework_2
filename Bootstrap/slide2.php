...
<div class="container">
    <div class="row">
            ...
            <div class="thumbnail">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Web Programming</li>
                    </ol>
                </nav>
                <img src="img/2.jfif" width="100%" alt="Cinque Terre">
                <div class="caption">
        ...
        <div class="col-sm-4">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="caption">
                        ...
                        <div class="row">
                            <div class="col-xl-3">
                                <img src="img/1.jpg" width="100%" alt="Cinque Terre">
                            </div>
                            <div class="col-sm-9">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisgna aliqua. adipisgna aliqua</p>
                            </div>
                ...
                <div class="col-sm-12">
                    <div class="caption">
                        ...
                        <div class="row">
                            <div class="col-xl-3">
                                <img src="img/3.jpg" width="100%" alt="Cinque Terre">
                            </div>
                            <div class="col-sm-9">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisgna aliqua. adipisgna aliqua</p>
                            </div>
                ...
                <div class="col-sm-12">
                    <div class="caption">
                        ...
                        <div class="row">
                            <div class="col-xl-3">
                                <img src="img/4.jfif" width="100%"alt="Cinque Terre">
                            </div>
                            <div class="col-sm-9">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisgna aliqua. adipisgna aliqua</p>
                            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <img src="img/iklan.jpg" width="100%"alt="Cinque Terre">
                </div>
            </div>
...
<div class="jumbotron text-center" style="margin-bottom:0">
    <p>Copyright 2020 Fauzan Ruslan</p>
</div>
</body>
</html>